...
List<TextSequence> get testSequences => [
      const TextSequence(
        ...
        voices: [
          ...
          ExampleVoice(
              id: 'female', uri: 'assets://examples/female/test-001.m4a'),
        ],
      ),
      const TextSequence(
        id: 'test-002',
        ...
        voices: [
          ...
          ExampleVoice(
              id: 'female', uri: 'assets://examples/female/test-002.m4a'),
        ],
      ),
      const TextSequence(
        id: 'test-003',
        ...
        voices: [
          ...
          ExampleVoice(
              id: 'female', uri: 'assets://examples/female/test-003.m4a'),
        ],
      ),
    ];
...
List<Override> createTestOverrides({
  ...
  final mockTextSequenceRepo =
      MockTextSequenceRepository(sequences ?? testSequences);
